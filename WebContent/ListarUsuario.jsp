...
<jsp:useBean id="usu" class="ifba.exemplo.model.UsuarioDAO"></jsp:useBean>
            ...
            <div class="mainpanel">
                <jsp:include page="./pageheader.jsp">
                    ...
                    <jsp:param name="pageLocation"
                               value="Manutencao / Listar Usuarios" />
                    <jsp:param name="pageName" value="Listar Usuarios" />
                        ...
                        <table class="table mb30 table-hover">
                            ...
                            <tbody>
                                <c:forEach var="usuario" items="${usuario.getListarTodos}">
                                    <tr>
